# PREPARACION-BD
sistema de Gestión Hospitalaria — Base de Datos SQL
...
Índices de optimización para mejorar el rendimiento en consultas frecuentes. Arquitectura de la Base de Datos
